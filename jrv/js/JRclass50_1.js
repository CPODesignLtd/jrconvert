...
var mesiceUTF = new Array("ledna", "˙nora", "b¯ezna", "dubna", "kvÏtna", "Ëervna", "Ëervence", "srpna", "z·¯Ì", "¯Ìjna", "listopadu", "prosince");
var mesiceW1250SK = new Array("janu·r","febru·r","marec","aprÌl","m·j","j˙n","jul","august","september","oktÛber","november","december");
var mesiceUTFSK = new Array("janu·r","febru·r","marec","aprÌl","m·j","j˙n","jul","august","september","oktÛber","november","december");
var info_1_UTF_CZ = "P¯edchozÌ zast·vka&nbsp;:&nbsp";
var info_1_W1250_CZ = "P¯edchozÌ zast·vka&nbsp;:&nbsp";
var info_1_UTF_SK = "P¯edchozÌ zast·vka&nbsp;:&nbsp";
var info_1_W1250_SK = "P¯edchozÌ zast·vka&nbsp;:&nbsp";

var info_2_UTF_CZ = "Nasleduj˙ca zast·vka&nbsp;:&nbsp;";
var info_2_W1250_CZ = "N·sledujÌcÌ zast·vka&nbsp;:&nbsp;";
var info_2_UTF_SK = "Nasleduj˙ca zast·vka&nbsp;:&nbsp;";
var info_2_W1250_SK = "Nasleduj˙ca zast·vka&nbsp;:&nbsp;";

var info_3_UTF_CZ = "N&nbsp;E&nbsp;S&nbsp;T&nbsp;A&nbsp;V&nbsp;Õ";
var info_3_W1250_CZ = "N&nbsp;E&nbsp;S&nbsp;T&nbsp;A&nbsp;V&nbsp;Õ";
...
if ((document.characterSet == 'utf-8') || (document.characterSet == 'UTF-8')) {
  var info_5_SK = "Zobraziù odjazdy";
...
/*  scriptObj = document.createElement("script");
  ...
  path = "//www.mhdspoje.cz/jrw50/js/";

  var sdaik = '';
  if ((document.characterSet === 'utf-8') || (document.characterSet === 'UTF-8')) {
    fullUrl = path + "diakW.js";
  ...
  scriptObj.setAttribute("id", "myscrDiak");
  document.body.appendChild(scriptObj);*/
if ((document.characterSet == 'utf-8') || (document.characterSet == 'UTF-8')) {
  sdiak = "·‰ËÔÈÏÌÂæÚÛÙˆ‡öù˙˘¸˝¯û¡ƒ»œ…ÃÕ≈º“”‘÷¿äç⁄Ÿ‹›ÿé";
} else {
  sdiak = "·‰ËÔÈÏÌÂæÚÛÙˆ‡öù˙˘¸˝¯û¡ƒ»œ…ÃÕ≈º“”‘÷¿äç⁄Ÿ‹›ÿé";
}
      ...
      for (i = 0; i < this.stanice.length; i++) {
        if ((this.stanice[i][1] > 0) || (this.stanice[i][2] > 0)) {
          ...
          var info = new google.maps.InfoWindow({
            ...
            content:
            '<table style="width: 100%;"><tr style="width: 100%;"><th style="text-align: center;"><a class="popisek" style = "text-align: center; font-size: 18px; width: 100%;">' + this.stanice[i][0] + '&nbsp;&nbsp;</a></th><th>&nbsp;&nbsp;</th></tr>' +
            '<trstyle="width: 100%;"><td id="seznamMap" style="width: 100%;"></td><td>&nbsp;&nbsp;&nbsp;&nbsp;</td></tr>'
    ...
    if (location == 6) {
      callfunc = function() {
        getJR(document.getElementById(selfobj.tagLinky).value, document.getElementById(selfobj.tagSmery).value, document.getElementById(selfobj.tagTrasy).value,
          ...
          0, null, null, null, 0, false, null, 0, null);
      }
...
function getJR(linka, smer, tarif, location, packet, denJR, datum, sdruzJR, sloupec, x, y, sel, adeleteonshow, packets, showkurz, incspoje, print) {
  ...
  if ((location == 6) && (denJR == 1)) {
    callfunc = function() {
      getJR(linka, smer, tarif,
        location, packet, 1, datum,
        0, sloupec, x, y, 0, sel, null, 0, null);
    }
  }
  scriptObj.setAttribute("src", fullUrl/* + noCacheIE*/);
...
function posunNaseptavac(e, aname) {
  ...
  if (unicode == 13) {
    ...
    // na enter ve textovÈm poli nechceme odesÌlat formul·¯
    if (window.event)
      e.returnValue = false;
    else
      e.preventDefault();
...
function processRequest(aname) {
  if (httpRequest.readyState == 4) {
    if(httpRequest.status == 200) {
      ...
      alert("Chyba p¯i naËÌt·nÌ str·nky"
