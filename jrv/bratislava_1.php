...
<html  xmlns="//www.w3.org/1999/xhtml">
  ...
  <body>
    ...
    <div id="secondary-nav">
      <ul>
        <li id="menu_content_1" <?php echo (($_GET[page] == 1) || (!isset ($_GET[page]))) ? 'class="active"': ''; ?>><a name="content_1" href="?page=1<?php echo ($showkurz == 1) ? '&kurz=1': ''; ?>">Jízdní řády</a></li>
        ...
        <li id="menu_content_3" <?php echo ($_GET[page] == 3) ? 'class="active"': ''; ?>><a name="content_3" href="?page=3<?php echo ($showkurz == 1) ? '&kurz=1': ''; ?>">Zastávky</a></li>
        <li id="menu_content_4" <?php echo ($_GET[page] == 4) ? 'class="active"': ''; ?>><a name="content_4" href="?page=4<?php echo ($showkurz == 1) ? '&kurz=1': ''; ?>">Spojení</a></li>
      </ul>
    </div>
        ...
        <table>
          <tr>
            <td>
              ...
              <button id="button_komplex_JR" onclick="JR.komplexJR(vlocation, vpacket, <?php echo ($showkurz == 1) ? '1': '0'; ?>);" title="komplexní jízdní řád" style="width: 150px; height: 35px; float: left; margin-right: 20px;">JŘ - komplexní</button>
              <!--        </div>-->
            </td>
            <td>
              <!--        <div class="div_vyber" style="float: left; margin-right: 20px;">-->
              <button id="button_den_JR" onclick="JR.denJR(vlocation, vpacket, <?php echo ($showkurz == 1) ? '1': '0'; ?>);" title="denní jízdní řád" style="width: 150px; height: 35px; float: left; margin-right: 20px;">JŘ - denní</button>
              <!--        </div>-->
            </td>
            <td>
              <!--        <div class="div_vyber" style="width: 100px;">-->
              <button id="button_sdruz_JR" onclick="JR.sdruzJR(vlocation, vpacket, <?php echo ($showkurz == 1) ? '1': '0'; ?>);" title="linkový jízdní řád" style="width: 150px; height: 35px; float: none;">JŘ - linkový</button>
              <!--        </div>-->
            </td>
          </tr>
        </table>
