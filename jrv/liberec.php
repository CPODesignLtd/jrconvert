...
<html  xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="css/JRLiberec/menuLiberec.css"/>
    <link rel="stylesheet" type="text/css" href="css/JRLiberec/JRLiberec.css"/>
    <link rel="stylesheet" type="text/css" href="css/JRLiberec/kalendarLiberec.css"/>
  </head>
  <body>
    <?php
    ...
    <div id="secondary-nav">
      <ul>
        ...
        <li id="menu_content_6" <?php echo ($_GET[page] == 6) ? 'class="active"' : ''; ?>><a name="content_6" href="?page=6">Odjezdy</a></li>
          ...
          <table>
            <tr>
              <td>
                ...
                <button id="button_komplex_JR" onclick="JR.komplexJR(vlocation, vpacket, 1);" title="komplexní jízdní řád" style="width: 150px; height: 35px; float: left; margin-right: 20px;">JŘ - komplexní</button>
                <!--        </div>-->
              </td>
              <td>
                <!--        <div class="div_vyber" style="float: left; margin-right: 20px;">-->
                <button id="button_den_JR" onclick="Kalend.setDatum(19, 7, 2013); JR.denJR(vlocation, vpacket, 1);" title="denní jízdní řád" style="width: 150px; height: 35px; float: left; margin-right: 20px;">JŘ - denní</button>
                <!--        </div>-->
              </td>
              <td>
                <!--        <div class="div_vyber" style="width: 100px;">-->
                <button id="button_sdruz_JR" onclick="JR.sdruzJR(vlocation, vpacket, 1);" title="linkový jízdní řád" style="width: 150px; height: 35px; float: none;">JŘ - linkový</button>
                <!--        </div>-->
              </td>
            </tr>
          </table>
  ...
  <!--      <input type="image" text="zobrazit JŘ" class="send" src="css/Plzen/buttonJR.png" onclick="JR.spojeniResult(vlocation, vpacket, Time.getHH(), Time.getMM());"></input>-->
    ...
    if ($_GET[page] == 6) {
      ...
      <div id="content_3" class="content_div">
        ...
        <div>
          <button id="button_seznam_zastavky" onclick="JR.odjezdyResult(vlocation, vpacket);" title="Nejbližší odjezdy" style="width: 150px; height: 35px; float: none;">Zobrazit</button>
        </div>
        <div class="div_separator">
        </div>
      </div>
...
<!--    <div id="route" name="route" style="width: 400px; height: 400px;"/>-->
