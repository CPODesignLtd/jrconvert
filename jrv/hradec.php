...
<html  xmlns="//www.w3.org/1999/xhtml">
  ...
  <body>
    ...
    <div id="secondary-nav">
      <ul>
        <li id="menu_content_1" <?php echo (($_GET[page] == 1) || (!isset ($_GET[page]))) ? 'class="active"': ''; ?>><a name="content_1" href="?<?php echo ($_GET[kurz] == 1) ? 'kurz=1&':''; ?>page=1">Jízdní řády</a></li>
        <li id="menu_content_6" <?php echo ($_GET[page] == 6) ? 'class="active"' : ''; ?>><a name="content_5" href="?<?php echo ($_GET[kurz] == 1) ? 'kurz=1&':''; ?>page=6">Odjezdy</a></li>
        <li id="menu_content_2" <?php echo ($_GET[page] == 2) ? 'class="active"': ''; ?>><a name="content_2" href="?<?php echo ($_GET[kurz] == 1) ? 'kurz=1&':''; ?>page=2">Linky</a></li>
        <li id="menu_content_3" <?php echo ($_GET[page] == 3) ? 'class="active"': ''; ?>><a name="content_3" href="?<?php echo ($_GET[kurz] == 1) ? 'kurz=1&':''; ?>page=3">Zastávky</a></li>
        <li id="menu_content_4" <?php echo ($_GET[page] == 4) ? 'class="active"': ''; ?>><a name="content_4" href="?<?php echo ($_GET[kurz] == 1) ? 'kurz=1&':''; ?>page=4">Spojení</a></li>
        <li id="menu_content_5" <?php echo ($_GET[page] == 5) ? 'class="active"' : ''; ?>><a name="content_5" href="?<?php echo ($_GET[kurz] == 1) ? 'kurz=1&':''; ?>page=5">Trasy</a></li>
      </ul>
    </div>
        ...
        <table>
          <tr>
            <td>
              ...
              <button id="button_komplex_JR" onclick="JR.komplexJR(vlocation, vpacket, <?php echo ($_GET[kurz] == 1) ? '1':'0'; ?>);" title="komplexní jízdní řád" style="width: 150px; height: 35px; float: left; margin-right: 20px;">JŘ - komplexní</button>
              <!--        </div>-->
            </td>
            <td>
              <!--        <div class="div_vyber" style="float: left; margin-right: 20px;">-->
              <button id="button_den_JR" onclick="JR.denJR(vlocation, vpacket, <?php echo ($_GET[kurz] == 1) ? '1':'0'; ?>);" title="denní jízdní řád" style="width: 150px; height: 35px; float: left; margin-right: 20px;">JŘ - denní</button>
              <!--        </div>-->
            </td>
            <td>
              <!--        <div class="div_vyber" style="width: 100px;">-->
              <button id="button_sdruz_JR" onclick="JR.sdruzJR(vlocation, vpacket, <?php echo ($_GET[kurz] == 1) ? '1':'0'; ?>);" title="linkový jízdní řád" style="width: 150px; height: 35px; float: none;">JŘ - linkový</button>
              <!--        </div>-->
            </td>
          </tr>
        </table>
...
<?php
    if ($_GET[page] == 6) {
      ...
      <div id="content_6" class="content_div">
        ...
        <div>
          <button id="button_seznam_zastavky" onclick="JR.odjezdyResult(vlocation, vpacket);" title="odjezdy" style="width: 150px; height: 35px; float: none;">Vyhledat</button>
        </div>
        <div class="div_separator">
        </div>
      </div>
...
<?php
if (($_GET[page] == 1) || ($_GET[page] == 2) || ($_GET[page] == 3) || ($_GET[page] == 4) || ($_GET[page] == 5) || ($_GET[page] == 6) || (!isset($_GET[page]))) {
    ?>
