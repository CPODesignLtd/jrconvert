...
<html  xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="css/JRDefault51/menuDefault.css"/>
    <link rel="stylesheet" type="text/css" href="css/JRDefault51/JRDefault.css"/>
    <link rel="stylesheet" type="text/css" href="css/JRDefault51/kalendarDefault.css"/>
  </head>
  <body>
    <?php
      ...
      <div>
        <table>
          <tr>
            ...
            <td>
              <button id="button_seznam_zastavky" onclick="JR.seznamKurzy(vlocation, vpacket);" title="Seznam kurzů" style="width: 150px; height: 35px; float: none;">Seznam kurzů</button>
            </td>
          </tr>
        </table>
      </div>
