...
//------- LINKY ------
    ...
    $sql1 = "select distinct linky.nazev_linky, linky.c_linkysort, linky.c_linky, zaslinky.c_zastavky,
            ...
            where zaslinky.idlocation = " . $location . " and zaslinky.packet = " . $packet . " and zaslinky.c_zastavky = " . $idzastavka . " and zaslinky.voz = 1
...
/*      $res = $res . "<a class='a_linka' style='height: 25px;' onClick = '" . "selfobj.changeZIndexJR(); getJR(" . $rowlinky[2] . ", 0, " . (integer) $rowlinky[4] . ", " . $location . ", " . $packet . ", 0, \"" . date_format(new DateTime($datumJR), 'd_m_Y') . "\", 0, null, null, null, null, 1);'>  "
                  ...
                  . $rowlinky[0] . "</a>";*/
      $res = $res . "<div class='a_linka' style='vertical-align: middle; width: 100%;' onClick = '" . "selfobj.changeZIndexJR(); getJR(" . $rowlinky[2] . ", 0, " . (integer) $rowlinky[4] . ", " . $location . ", " . $packet . ", 0, \"" . date_format(new DateTime($datumJR), 'd_m_Y') . "\", 0, null, null, null, null, 1);'>  "
