...
$res = $res . "function changeHeader() {
  " . $_GET[implement] . ".setKalendar(" . $day . ", document.getElementById('select_mesic1').value, " . $nextY . ", " . $pday . ", " . $pmonth . ", " . $pyear . ", false); 
  };";
$res = $res . "</script>";

// vykresleni kalendare
$res = $res . "<div class='ram_kalendar' id='div_kalendar1'>";
$res = $res . "<table class='table_kalendar' id='table_kalendar1'>";
$res = $res . "<tr>";
$res = $res . "<td>";
...
$res = $res . "<select class='vyber_kalendar' id='select_mesic1' onchange = '" . $_GET[implement] . ".kalendarChange(" . $day . ",\"select_mesic1\", \"select_rok1\", " . $pday . ", " . $pmonth . ", " . $pyear . ", false);'>";
...
$res = $res . "<select class='vyber_kalendar' id='select_rok1' onchange = '" . $_GET[implement] . ".kalendarChange(" . $day . ",\"select_mesic1\", \"select_rok1\", " . $pday . ", " . $pmonth . ", " . $pyear . ", false);'>";
