               ...
               if (status == google.maps.places.PlacesServiceStatus.OK) {
                 ...
                 for(i = 0; i < this.vybrane_stanice.length; i++) {
                   if (this.vybrane_stanice[i] != null) {
                     ...
                     this.vyhledane_stanice[iter] = this.vybrane_stanice[i];//zaznam;//this.vybrane_stanice[i];
                     iter++;
                   }
                 }
               }
...
var self = this;
var tSearch_result = self.vyhledane_stanice[0][3];
            this.routediv = 'divRoute';
            if (this.vyhledane_stanice[0][3] >= 0) {
    ...
    //                center: latlng,
        ...
        /*            if (self.lang == 'cz') {
                    ...
                    for (i = 0; i < self.vyhledane_stanice.length; i++) {
                        ...
                        if (this.vyhledane_stanice[0][3] == self.vyhledane_stanice[i][3]) {
