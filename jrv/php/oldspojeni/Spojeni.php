    ...
    if (($this->vyhledaneSpoje != null) && ($this->vyhledaneSpoje->size() > 0)) {
      for ($i = 0; $i < $this->vyhledaneSpoje->size(); $i++) {
        ...
        for ($ii = 0; $ii < $this->vyhledaneSpoje->elementAt($i)->size(); $ii++) {
          ...
          $res = $res . (($Spoj->SpojDetail->OdjezdPrijezd->elementAt(0)->Odjezd->H < 10) ? "0" . $Spoj->SpojDetail->OdjezdPrijezd->elementAt(0)->Odjezd->H : $Spoj->SpojDetail->OdjezdPrijezd->elementAt(0)->Odjezd->H) . " : " . (($Spoj->SpojDetail->OdjezdPrijezd->elementAt(0)->Odjezd->M < 10) ? "0" . $Spoj->SpojDetail->OdjezdPrijezd->elementAt(0)->Odjezd->M : $Spoj->SpojDetail->OdjezdPrijezd->elementAt(0)->Odjezd->M);
          $res = $res . "</td>";
          ...
          if ($ii == $this->vyhledaneSpoje->elementAt($i)->size() - 1) {
            $res = $res . "<td style='padding: 5px 5px 5px 5px; white-space: normal; font-weight: bold'>";
          } else {
            $res = $res . "<td style='padding: 5px 5px 5px 5px; white-space: normal;'>";
          }
          $res = $res . (($Spoj->SpojDetail->OdjezdPrijezd->elementAt(0)->Prijezd->H < 10) ? "0" . $Spoj->SpojDetail->OdjezdPrijezd->elementAt(0)->Prijezd->H : $Spoj->SpojDetail->OdjezdPrijezd->elementAt(0)->Prijezd->H) . " : " . (($Spoj->SpojDetail->OdjezdPrijezd->elementAt(0)->Prijezd->M < 10) ? "0" . $Spoj->SpojDetail->OdjezdPrijezd->elementAt(0)->Prijezd->M : $Spoj->SpojDetail->OdjezdPrijezd->elementAt(0)->Prijezd->M);
          $res = $res . "</td>";
...
//          echo "Linka : " . $Spoj->Linka . "( " . $Spoj->nazev_linky . " - " . $Spoj->doprava;
//          echo $Spoj->SpojDetail->ZeZastavky . " - " . $Spoj->SpojDetail->OdjezdPrijezd->elementAt(0)->Odjezd->H . ":" . $Spoj->SpojDetail->OdjezdPrijezd->elementAt(0)->Odjezd->M . ", " . $Spoj->SpojDetail->DoZastavky . " - " . $Spoj->SpojDetail->OdjezdPrijezd->elementAt(0)->Prijezd->H . ":" . $Spoj->SpojDetail->OdjezdPrijezd->elementAt(0)->Prijezd->M; //
        }
