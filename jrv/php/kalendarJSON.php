...
$res = $res . "<select class='vyber_kalendar' id='" . $_GET[implement] . "select_mesic' onchange = '" . $_GET[implement] . ".kalendarChange(" . $day . ",\"" . $_GET[implement] . "select_mesic\", \"" . $_GET[implement] . "select_rok\", " . $pday . ", " . $pmonth . ", " . $pyear . ", false);'>";
foreach ($cz_months as $key => $val) {
  if ($key == $title) {
    $res = $res . "<option selected='selected' value=" . $key . ">" . iconv('ISO-8859-2', 'UTF-8', $val) . "</option>";
  } else {
    $res = $res . "<option value=" . $key . ">" . iconv('ISO-8859-2', 'UTF-8', $val) . "</option>";
  }
}
$res = $res . "</select>";
//$res = $res .  "</div>";
...
$res = $res . "<select class='vyber_kalendar' id='" . $_GET[implement] . "select_rok' onchange = '" . $_GET[implement] . ".kalendarChange(" . $day . ",\"" . $_GET[implement] . "select_mesic\", \"" . $_GET[implement] . "select_rok\", " . $pday . ", " . $pmonth . ", " . $pyear . ", false);'>";
for ($rok = $year - 1; $rok < $year + 10; $rok++) {
  if ($rok == $year) {
    $res = $res . "<option selected='selected' value=" . $rok . ">" . iconv('ISO-8859-2', 'UTF-8', $rok) . "</option>";
  } else {
    $res = $res . "<option value=" . $rok . ">" . iconv('ISO-8859-2', 'UTF-8', $rok) . "</option>";
  }
}
$res = $res . "</select>";
$res = $res . "</div>";
...
if ($lang == 'sk') {
  $res = $res . "<td class='td_dny'><div class='div_ram_den'><a>" . iconv('ISO-8859-2', 'UTF-8', "Po") . "</a></div></td>";
  $res = $res . "<td class='td_dny'><div class='div_ram_den'><a>" . iconv('ISO-8859-2', 'UTF-8', "Ut") . "</a></div></td>";
  $res = $res . "<td class='td_dny'><div class='div_ram_den'><a>" . iconv('ISO-8859-2', 'UTF-8', "St") . "</a></div></td>";
  $res = $res . "<td class='td_dny'><div class='div_ram_den'><a>" . iconv('CP1250', 'UTF-8', "Št") . "</a></div></td>";
  $res = $res . "<td class='td_dny'><div class='div_ram_den'><a>" . iconv('ISO-8859-2', 'UTF-8', "Pi") . "</a></div></td>";
  $res = $res . "<td class='td_dny'><div class='div_ram_den'><a>" . iconv('ISO-8859-2', 'UTF-8', "So") . "</a></div></td>";
  $res = $res . "<td class='td_dny'><div class='div_ram_den'><a>" . iconv('ISO-8859-2', 'UTF-8', "Ne") . "</a></div></td>";
}
if ($lang == 'cz') {
  $res = $res . "<td class='td_dny'><div class='div_ram_den'><a>" . iconv('ISO-8859-2', 'UTF-8', "Po") . "</a></div></td>";
  $res = $res . "<td class='td_dny'><div class='div_ram_den'><a>" . iconv('ISO-8859-2', 'UTF-8', "Út") . "</a></div></td>";
  $res = $res . "<td class='td_dny'><div class='div_ram_den'><a>" . iconv('ISO-8859-2', 'UTF-8', "St") . "</a></div></td>";
  $res = $res . "<td class='td_dny'><div class='div_ram_den'><a>" . iconv('ISO-8859-2', 'UTF-8', "Èt") . "</a></div></td>";
  $res = $res . "<td class='td_dny'><div class='div_ram_den'><a>" . iconv('ISO-8859-2', 'UTF-8', "Pá") . "</a></div></td>";
  $res = $res . "<td class='td_dny'><div class='div_ram_den'><a>" . iconv('ISO-8859-2', 'UTF-8', "So") . "</a></div></td>";
  $res = $res . "<td class='td_dny'><div class='div_ram_den'><a>" . iconv('ISO-8859-2', 'UTF-8', "Ne") . "</a></div></td>";
}
$res = $res . "</tr>";
